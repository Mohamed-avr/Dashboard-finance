...
const turnAnIcon = () => {
    return (
        ...
        <path d="M11.7179 3.39345C11.6596 3.39345 11.6014 3.38512 11.5431 3.36847C11.3016 3.30186 11.0685 3.2519 10.8437 3.2186C10.1359 3.12701 9.45315 3.17696 8.81201 3.36847C8.57888 3.44341 8.32908 3.36847 8.17088 3.19362C8.01268 3.01876 7.96272 2.76897 8.05431 2.54416C8.39569 1.66989 9.22833 1.09537 10.1775 1.09537C11.1268 1.09537 11.9594 1.66156 12.3008 2.54416C12.384 2.76897 12.3424 3.01876 12.1842 3.19362C12.0593 3.32684 11.8845 3.39345 11.7179 3.39345Z" fill="#9E9E9E"/>
        <path d="M10.1691 19.1053C9.34481 19.1053 8.54547 18.7723 7.96262 18.1894C7.37978 17.6066 7.04672 16.8073 7.04672 15.9829H8.29568C8.29568 16.4742 8.49551 16.9571 8.84522 17.3068C9.19493 17.6565 9.67786 17.8564 10.1691 17.8564C11.2016 17.8564 12.0426 17.0154 12.0426 15.9829H13.2915C13.2915 17.7065 11.8927 19.1053 10.1691 19.1053Z" fill="#9E9E9E"/>
        <circle cx="14.3157" cy="4.27605" r="2.0816" fill="#1FCB4F" stroke="#1A1C22" stroke-width="0.832639"/>
        </svg>
    )
}
